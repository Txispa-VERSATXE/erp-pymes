    ...
    <div class="col-md-8">
        <div class="card">
            <div style="padding:16px 20px;border-bottom:1px solid rgba(0,0,0,0.08);display:flex;align-items:center;justify-content:space-between;">
                <h2 style="font-size:14px;font-weight:600;margin:0;">Editar producto</h2>
                ...
                <form method="POST" action="{{ route('productos.update', $producto->id) }}">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="precio" class="form-control" value="{{ old('precio', $producto->precio) }}" step="0.01" min="0" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" style="font-size:12px;font-weight:600;color:#6b6a66;">Stock *</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="umbral_min" class="form-control" value="{{ old('umbral_min', $producto->umbral_min) }}" min="0" required>
                        </div>
